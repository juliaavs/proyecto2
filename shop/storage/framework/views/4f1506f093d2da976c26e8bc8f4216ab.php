                ...
                <?php $__currentLoopData = $ultimosProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-6 col-md-3 position-relative text-center">
                        ...
                        <?php if($producto->stock < 20): ?>
                            <span class="badge bg-warning text-dark position-absolute bottom-0 start-0 m-2">¡Quedan <?php echo e($producto->stock); ?>!</span>
                        <?php endif; ?>
                    </div>
                ...
                <?php $__currentLoopData = $ultimosProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('shoes.preview', $producto->id)); ?>" class="me-2 text-center" style="flex: 0 0 auto;">
                        ...
                        <div style="font-size: 0.9em;">
                            ...
                            <?php endif; ?>
                            <?php if($producto->stock < 20): ?>
                                <div class="text-warning">¡Quedan <?php echo e($producto->stock); ?>!</div>
                            <?php endif; ?>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/julia/Desktop/proyecto2/shop/resources/views/home.blade.php ENDPATH**/ ?>