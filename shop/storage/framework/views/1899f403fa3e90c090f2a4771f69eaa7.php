        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <form action="<?php echo e(route('checkout')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="btn btn-primary">Añadir direccion de envio</button>
                </form>            
            </div>
        </div>
    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/julia/Documents/docker-shop/shop/resources/views/cart/index.blade.php ENDPATH**/ ?>